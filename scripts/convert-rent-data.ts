...
const AREA_DESCRIPTIONS: Record<string, string> = {
  ...
  '知多市': '知多半島の中央に位置し、新舞子マリンパークなど海のレジャースポットが豊富。名鉄常滑線が利用可能。「佐布里池」の梅まつりも有名。海と緑に囲まれた環境で、のびのびと暮らせます。',
  '知立市': 'かつての東海道の宿場町。名鉄名古屋本線・三河線が交わる知立駅は交通の要衝。「知立神社」のかきつばたは有名。名古屋へのアクセスが良く、コンパクトで住みやすい街です。',
  '尾張旭市': '名古屋市に隣接するベッドタウン。名鉄瀬戸線が利用可能。「愛知県森林公園」は広大で、バーベキューやスポーツが楽しめます。閑静な住宅街が広がり、子育て世帯に人気です。',
  '高浜市': '三州瓦の産地として知られる工業都市。名鉄三河線が利用可能。コンパクトな市域で、海にも近く開放的。衣浦港の工業地帯もあり、働く場所にも恵まれています。',
  '岩倉市': '愛知県で最も小さな市ですが、名鉄犬山線（岩倉駅）で名古屋駅まで約15分と抜群のアクセス。五条川の桜並木は「日本さくら名所100選」。コンパクトで住みやすく、若い世代に人気です。',
  '豊明市': '「桶狭間の戦い」の古戦場がある歴史の街。名鉄名古屋本線が利用可能で、名古屋駅まで約20分。藤田医科大学病院があり、医療環境が充実。住宅開発が進み、ファミリー層に人気です。',
  '田原市': '渥美半島に位置し、三方を海に囲まれた自然豊かな街。「伊良湖岬」や「恋路ヶ浜」は絶景スポット。メロンやキャベツの一大産地。サーフィンやウインドサーフィンのメッカで、マリンスポーツ愛好家に人気です。',
  '愛西市': '木曽川に囲まれた水郷地帯。蓮根の産地として有名。名鉄津島線や尾西線が利用可能。「船頭平閘門」は国の重要文化財。のどかな田園風景が広がり、静かな環境で暮らせます。',
  '清須市': '織田信長ゆかりの「清洲城」がある歴史の街。JR東海道線や名鉄名古屋本線が利用でき、名古屋駅まで約10分。キリンビール工場もあります。都心に近い割に家賃が手頃で、コスパの良い街です。',
  '北名古屋市': '名古屋市の北に隣接するベッドタウン。名鉄犬山線（徳重・名古屋芸大駅など）が利用可能。「ジャンボエンチョー」などの大型店もあり、買い物環境が良好。新しい住宅が増え、若いファミリー層に人気です。',
  '弥富市': '金魚の産地として全国的に有名。近鉄名古屋線やJR関西本線が利用可能。名古屋駅や津方面へのアクセスが良好。伊勢湾岸自動車道の弥富ICもあり、車移動も便利です。',
  'みよし市': 'トヨタの企業城下町の一つ。名鉄豊田線（三好ヶ丘駅など）が利用可能。「三好公園」は広大で、スポーツ施設が充実。財政が豊かで公共サービスが充実しており、子育て支援も手厚い街です。',
  'あま市': '甚目寺観音で知られる歴史ある街。名鉄津島線が利用可能。七宝焼の伝統工芸も有名。名古屋市に隣接し、ベッドタウンとして発展。家賃相場が手頃で、住みやすい環境が整っています。',
  ...
  '北九州市戸畑区': '北九州市で最も小さな区ですが、JR鹿児島本線（戸畑駅）で交通至便。新日鉄の企業城下町として発展。コンパクトで生活に必要な施設が揃い、住みやすいと評判。「夜宮公園」の藤棚は見事です。',
  '北九州市小倉南区': '小倉駅南側に広がる広大なエリア。北九州モノレール（企救丘駅など）やJR日田彦山線が利用可能。「平尾台」はカルスト台地で、ハイキングや鍾乳洞探検が楽しめます。自然豊かで、のどかな田園風景も広がります。',
  '北九州市八幡東区': '「官営八幡製鐵所」があり、世界遺産の構成資産を含む工業の街。JR鹿児島本線（スペースワールド駅など）が利用可能。「いのちのたび博物館」は恐竜の展示で有名。レトロな工業遺産と新しい文化施設が共存します。',
  '直方市': '筑豊地方の中心都市の一つ。JR筑豊本線と平成筑豊鉄道が交わる交通の要衝。「直方チューリップフェア」は春の風物詩。炭鉱の歴史を伝える「直方石炭記念館」もあります。家賃相場が安く、のんびりとした暮らしが送れます。',
  '田川市': 'かつての炭鉱の街で、「田川市石炭・歴史博物館」や世界遺産の「三井三池炭鉱宮原坑」などがあります。JR日田彦山線・後藤寺線が利用可能。「風治八幡宮川渡り神幸祭」は山笠で有名。歴史と伝統が息づく街です。',
  '八女市': '高級茶「八女茶」の産地として全国的に有名。白壁の町並みや「八女福島の燈籠人形」など、伝統文化が色濃く残ります。西鉄バスが主な交通手段。手すき和紙や提灯などの伝統工芸も盛ん。静かで文化的な暮らしが送れます。',
  '筑後市': '筑後平野の中心に位置する農業の街。JR鹿児島本線（羽犬塚駅）が利用可能。「恋木神社」は恋愛のパワースポットとして人気。広大な田園風景が広がり、のどかで穏やかな環境。九州新幹線・筑後船小屋駅もあり、交通至便です。',
  '大川市': '「家具の街」として有名で、大川家具は全国的なブランド。筑後川沿いに位置し、水郷の風景が広がります。西鉄バスが主な交通手段。木工職人の技が光る街で、家具好きにはたまらない環境です。',
  '豊前市': '宇島港があり、海の幸が豊富。JR日豊本線（宇島駅）が利用可能。「求菩提山」は修験道の霊場で、ハイキングスポット。のどかな田舎町で、海と山の自然に囲まれた静かな暮らしが楽しめます。',
  '中間市': '北九州市と直方市の中間に位置するベッドタウン。筑豊電鉄が利用可能。コンパクトな市域で、生活に必要な施設が揃っています。遠賀川の河川敷は散策やジョギングに最適。家賃相場が手頃で、住みやすい街です。',
  '小郡市': '「九州自動車道小郡IC」があり、車でのアクセスが便利。西鉄大牟田線（小郡駅）や甘木鉄道も利用可能。「小郡運動公園」は大規模で、スポーツ施設が充実。福岡市や久留米市へのアクセスが良く、ベッドタウンとして人気です。',
  '古賀市': '福岡市と福津市の間に位置するベッドタウン。JR鹿児島本線（古賀駅）で博多まで約20分。「古賀グリーンパーク」は緑豊かな憩いの場。新しい住宅が増え、若いファミリー層に人気の成長中の街です。',
  'うきは市': '「筑後吉井」は白壁の町並みが美しい重要伝統的建造物群保存地区。フルーツ王国として知られ、ぶどうや梨、柿などの果樹園が多数。JR久大本線が利用可能。自然と歴史が調和した、のどかで美しい街です。',
  '宮若市': '日産自動車九州工場があり、自動車産業の街。「脇田温泉」は歴史ある温泉地。JR筑豊本線（教育大前駅など）が利用可能。豊かな自然に囲まれ、温泉も楽しめる、リラックスした暮らしができます。',
  '嘉麻市': '「嘉麻三山」に囲まれた山あいの街。筑豊地方の炭鉱の歴史を伝える施設も。JR筑豊本線や平成筑豊鉄道が利用可能。自然豊かで、キャンプやハイキングが楽しめます。家賃相場が非常に安く、スローライフに最適です。',
  '朝倉市': '「秋月城下町」は小京都と呼ばれる美しい街並み。「朝倉の三連水車」は国の史跡で、田園風景の中で回る姿は圧巻。西鉄バスや甘木鉄道が利用可能。フルーツや温泉も豊富で、自然と歴史を満喫できます。',
  'みやま市': '有明海に面し、海苔の養殖が盛ん。西鉄天神大牟田線（江の浦駅など）が利用可能。「道の駅みやま」では地元の農産物や海産物が手に入ります。のどかな田園と海辺の風景が広がり、静かに暮らせます。',
  '那珂川市': '福岡市の南に隣接し、「那珂川清流」が流れる自然豊かな街。西鉄バスが主な交通手段ですが、博多南駅（新幹線の車両基地）も利用可能。住宅開発が進み、福岡市のベッドタウンとして人気急上昇中です。',
};
